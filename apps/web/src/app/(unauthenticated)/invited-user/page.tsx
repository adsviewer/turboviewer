...
import { getLoginProviders } from '@/app/(unauthenticated)/sign-in/actions';
import LoginProviders from '@/app/(unauthenticated)/components/login-providers';

export default function InvitedUser(): React.JSX.Element {
