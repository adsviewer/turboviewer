...
export function useNewIntegrationSubscription<TData = NewIntegrationSubscription>(
  options?: Omit<Urql.UseSubscriptionArgs<NewIntegrationSubscriptionVariables>, 'query'>,
  handler?: Urql.SubscriptionHandler<NewIntegrationSubscription, TData>,
) {
