...
export const metadata: Metadata = {
  title: 'adsViewer.io - Privacy Policy',
};
  ...
  return (
    <div className="flex w-full p-20 pt-40">
      <section className="text-justify">
        ...
        <p>
          <b>Last updated:</b> September 20, 2022
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Lbstr Digital, Bloemistenlaan 44, 2313bb, Leiden.
            </p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to adsviewer, accessible from{' '}
              <a href="https://adsviewer.io/" rel="external nofollow noopener" target="_blank">
                https://adsviewer.io/
              </a>
            </p>
          </li>
        ...
        <ul>
          ...
          <li>
            <strong>Automatically from You</strong>. For example, through cookies We or our Service Providers set on
            Your Device as You navigate through our Service.
          </li>
          <li>
            <strong>From Service Providers</strong>. For example, or other third-party vendors that We use to provide
            the Service to You.
          </li>
        </ul>
        ...
        <p>
          ...
          and privacy policies and we encourage parents and legal guardians to monitor their children's Internet usage
          and instruct their children to never provide information on other websites without their permission.
        </p>
        <p>
          ...
          and 16 years of age, or the parent or guardian of a Consumer less than 13 years of age. Consumers who opt-in
        ...
        <ul>
          <li>
            <strong>The right to notice.</strong> You have the right to be notified which categories of Personal Data
        ...
        <ul>
          <li>By email: info@adsviewer.io</li>
        </ul>
        <p>
