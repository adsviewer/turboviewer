...
void describe('splitTimeRange tests', () => {
  ...
  void it('one day over threshold, two ranges', () => {
    const ranges = splitTimeRange(new Date('2021-01-01T00:00:00Z'), new Date('2021-04-01T00:00:00Z'));
  ...
  void it('just over three ranges, three ranges', () => {
    const ranges = splitTimeRange(new Date('2021-01-01T00:00:00Z'), new Date('2021-06-30T00:00:00Z'));
