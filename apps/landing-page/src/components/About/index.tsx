          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">{t('feature1Title')}</h3>
                  <p>{t('feature1Body')}</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">{t('feature2Title')}</h3>
                  <p>{t('feature2Body')}</p>
                </div>
              </div>
            </motion.div>
      ...
      <section>
        <div className="mx-auto max-w-c-1235 overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="font-medium uppercase text-black dark:text-white">{t('launchFast')}</h4>
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                {t('packedAllEssentials')} {'   '}
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg2 dark:before:bg-titlebgdark">
                  {t('integrations')}
                </span>
              </h2>
              <p>{t('launchFastBody')}</p>
              <div>
                <a
                  href="/"
