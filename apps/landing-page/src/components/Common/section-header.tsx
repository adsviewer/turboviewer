...
function SectionHeader({ headerInfo }: { headerInfo: HeaderInfo }): ReactNode {
    ...
    <>
      ...
      >
        <div className="mb-4 inline-block rounded-full bg-zumthor px-4.5 py-1.5 dark:border dark:border-strokedark dark:bg-blacksection">
          <span className="uppercase text-sectiontitle font-medium text-black dark:text-white">{title}</span>
        </div>
