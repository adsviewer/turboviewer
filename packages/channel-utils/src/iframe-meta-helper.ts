...
export const formatDimensionsMap = new Map<FormatType, { height: number; width: number }>([
  ...
  [FormatType.DesktopFeedStandard, { height: 810, width: 500 }],
  [FormatType.FacebookProfileFeedDesktop, { height: 445, width: 260 }],
  [FormatType.FacebookProfileFeedMobile, { height: 445, width: 280 }],
  ...
  [FormatType.InstagramExploreImmersive, { height: 560, width: 320 }],
  ...
  [FormatType.InstagramProfileFeed, { height: 570, width: 330 }],
  // [FormatType.InstagramProfileReels, { height: 0, width: 0 }],
  [FormatType.InstagramReels, { height: 570, width: 330 }],
  // [FormatType.InstagramReelsOverlay, { height: 0, width: 0 }],
  // [FormatType.InstagramSearchChain, { height: 0, width: 0 }],
  [FormatType.InstagramSearchGrid, { height: 570, width: 330 }],
  [FormatType.InstagramStandard, { height: 570, width: 330 }],
  [FormatType.InstagramStory, { height: 570, width: 330 }],
  // [FormatType.InstagramStoryEffectTray, { height: 0, width: 0 }],
  [FormatType.InstagramStoryWeb, { height: 460, width: 280 }],
  [FormatType.InstagramStoryWebMSite, { height: 460, width: 280 }],
  ...
  [FormatType.InstreamVideoDesktop, { height: 770, width: 510 }],
  ...
  [FormatType.InstreamVideoMobile, { height: 570, width: 330 }],
  // [FormatType.JobBrowserDesktop, { height: 0, width: 0 }],
  // [FormatType.JobBrowserMobile, { height: 0, width: 0 }],
  [FormatType.MarketplaceDesktop, { height: 580, width: 330 }],
  [FormatType.MarketplaceMobile, { height: 215, width: 160 }],
  [FormatType.MessengerMobileInboxMedia, { height: 700, width: 400 }],
  [FormatType.MessengerMobileStoryMedia, { height: 570, width: 330 }],
  // [FormatType.MobileBanner, { height: 0, width: 0 }],
  // [FormatType.MobileFeedBasic, { height: 0, width: 0 }],
  [FormatType.MobileFeedStandard, { height: 530, width: 270 }],
